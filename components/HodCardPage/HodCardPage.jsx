...
import styles from "../HodCardPage/HodCardPage.module.css";
//   };
export default function HoDCardPage(props) {
  const dispData = props.dispData;
  console.log(dispData);
  const [parentConsent, setParentConsent] = useState(
    dispData.is_parent_consent
  );
  const [staffConsent, setStaffConsent] = useState(dispData.is_HOD_consent);
